...
namespace RentARoom.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            if (!_roleManager.RoleExistsAsync(SD.Role_User).GetAwaiter().GetResult())
            {
                ...
                _roleManager.CreateAsync(new IdentityRole(SD.Role_Agent)).GetAwaiter().GetResult();
            }
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //populate user prooperties from registration POST
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        //auto assign nothing to basic user
